...
### 2. Train Model
```
python3 train.py --name cifar10-100_500 --dataset cifar10 --model_type ViT-B_16 --pretrain_dir checkpoint/ViT-B_16.npz
```
...
```
python3 train.py --name cifar10-100_500 --dataset cifar10 --model_type ViT-B_16 --pretrain_dir checkpoint/ViT-B_16.npz --fp16 --fp16_opt_level O2
```
...
|   ViT_B_16   | CIFAR-100 |  224x224   |       -       |     0.923 (me:92.46)(h4:86.1)      |  3h 9m  |
